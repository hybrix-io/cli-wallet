...
function main () {
  ...
  const ops = stdio.getopt({
    ...
    nopending: {key: 'NP', description: 'Skip adding send transaction to pending'},
    novalidate: {key: 'NV', args: 0, description: 'Skip validation of target address and available balance before transaction'},
